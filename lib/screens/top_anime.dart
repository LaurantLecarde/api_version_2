...
import 'package:api_version_2/screens/random_anime.dart';
...
class RandomAnimes extends StatefulWidget {
  const RandomAnimes({super.key});

  @override
  State<RandomAnimes> createState() => _MainPageState();
}

class _MainPageState extends State<RandomAnimes> {
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(onPressed: (){
            Navigator.of(context).push(CupertinoPageRoute(builder: (context)=>TopAnimes()));
  ...
  _buildCarusel(){
    return SizedBox(
      ...
      child: CarouselSlider.builder(
        ...
        itemCount: _viewModel.topAnimeList.length,
        itemBuilder: (context, index, pageIndex) => OpenContainer(
          closedElevation: 0,
          closedBuilder: (context, invoke) {
            final anime = _viewModel.topAnimeList[index];
            return Card(
                elevation: 5,
